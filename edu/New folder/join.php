...
if(isset($_GET['join_user'])){
	...
	if($flag==1){
		...
		$query = mysqli_query($con, "insert into user(`Name`, `dob`, `gender`,`country`, `email`, `password` ,`mobile`, `address`, `under_userid`, `side`,`status`, `image`) values('$name', '$dob', '$gender','$country' , '$email', '$password', '$mobile', '$address', '$under_userid', '$side','$status','$image')");
		...
		while($total_count==1){
			...
			if($temp_under_userid!="" && (15-$i)>0){
				...
				$temp_left_count = $tree_data['leftcount'];
					...
					$new_total_bal = $income_data['total_bal']+(15-$i);
                    	...
                    	<form method="get">
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
                                ...
                                <input type="text" name="dob" class="form-control" id="" required><a href="javascript:NewCal('dob','ddmmyyyy')"><img src="images/cal.png" width="16" height="16" border="0" alt="Pick a date"></a>
                            </div>
							<div class="form-group">
                                <label>Gender</label>
