...
<table>
	...
	<tr><td>amount</td><td><input type="text" name="amount" value="200" /></td></tr>
	...
	<tr><td>success url</td><td><input type="text" name="surl" value="http://localhost/mlm/success1.php" size="64" /></td></tr>
	<tr><td>failure url</td><td><input type="text" name="furl" value="http://localhost/mlm/failure1.php" size="64" /></td></tr>
