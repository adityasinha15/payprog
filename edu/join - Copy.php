...
if(isset($_POST['join_user'])){
	...
	if($flag==1){
		...
		$query = mysqli_query($con, "insert into usr(`fullname`, `dob`, `gender`,`country`, `email`, `password` ,`mobile`, `address`, `sponsor`, `position`,`status`, `image`, `doj`) values('$name', '$dob', '$gender','$country' , '$email', '$password', '$mobile', '$address', '$under_userid', '$side','$status','$image', '$date')");
	...
	<option value="other">other</option>
                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <input type="text" name="document" class="form-control" placeholder="Enter your AADHAAR number" required>
                            </div>
							  <div class="form-group">
                                <label>Upload  User Sign</label>
                           <input type="file" name="user_sign">
						    <label>Upload  Trainer's Sign</label>
                           <input type="file" name="user_sign"> 
